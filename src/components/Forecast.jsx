...
const Forecast = ({ forecast }) => {
  ...
  return (
    <div className="my-4">
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-5 gap-4">
        {forecast.map((day, idx) => (
          <div key={idx} className="bg-white shadow rounded-lg p-4 flex flex-col items-center transition-transform hover:scale-105 w-full">
